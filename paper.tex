...
\textbf{FedUA-Net (CKA-Personalized)} & $\mathbf{93.87 \pm 0.94}$ & $\mathbf{93.73 \pm 1.08}$ & $\mathbf{0.904 \pm 0.016}$ & $0.0588$ & $\mathbf{0.0307}$ & $\mathbf{2.19 \pm 0.17}$ \\
Centralized (Pooled) & $93.45 \pm 1.30$ & $93.36 \pm 1.38$ & $0.895 \pm 0.024$ & $0.0714$ & --- & --- \\
\textbf{FedUA-Net (Uniform Baseline)} & $93.30 \pm 1.13$ & $93.05 \pm 1.36$ & $0.894 \pm 0.019$ & $\mathbf{0.0504}$ & $\mathbf{0.0307}$ & $2.33 \pm 0.23$ \\
...
\begin{table}[t]
\centering
\caption{Per-client classification accuracy (\%) across individual clinical sites (mean $\pm$ std).}
...
\textbf{FedUA-Net (CKA-Pers.)} & $95.89 \pm 0.18$ & $\mathbf{90.26 \pm 3.00}$ & $95.46 \pm 0.25$ \\
Centralized & $96.38 \pm 0.25$ & $88.03 \pm 4.52$ & $95.93 \pm 0.66$ \\
\textbf{FedUA-Net (Baseline)} & $\mathbf{96.06 \pm 0.29}$ & $88.60 \pm 3.56$ & $95.23 \pm 0.42$ \\
...
\begin{itemize}
    ...
    \item \textbf{Impact of Ultrasound Data Augmentation:} We systematically evaluated domain-specific ultrasound augmentations across 5 independent seeds on Hospital B under varying distortion regimes: heavy augmentations ($\sigma=0.08, p=0.5$; $\alpha=25.0, \sigma=4.0$) achieved $88.38 \pm 2.68\%$ alone and $88.89 \pm 4.36\%$ combined with personalization; milder augmentations ($\sigma=0.04, p=0.3$; $\alpha=15.0, \sigma=4.0$) achieved $88.72 \pm 4.25\%$ alone. Both hover around the unaugmented uniform baseline ($88.60 \pm 3.56\%$). This demonstrates that architectural personalization (\texttt{--personalize\_deep}, achieving \textbf{$90.26 \pm 3.00\%$}) is the decisive factor in resolving cross-modality acoustic shift, while synthetic geometric warping and noise injection risk perturbing diagnostic lesion margins in data-scarce ultrasound cohorts ($N=546$).
\end{itemize}
